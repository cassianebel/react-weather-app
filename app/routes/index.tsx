      ...
      >
        <div className="relative block w-full">
          <input
            ...
            className="bg-indigo-200 dark:bg-neutral-800 rounded-xl p-3 ps-16 text-lg placeholder:text-indigo-700 dark:placeholder:text-neutral-200 block w-full bg-[url(../images/icon-search-copy.svg)] dark:bg-[url(../images/icon-search.svg)] bg-no-repeat bg-[1.5rem] outline-indigo-500 dark:outline-white outline-offset-4 transition-colors duration-300"
            role="combobox"
